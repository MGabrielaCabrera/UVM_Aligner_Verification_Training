`ifndef CFS_MD_ITEM_DRV_MASTER_SV
    ...
    class cfs_md_item_drv_master extends cfs_md_item_drv;
        ...
        constraint pre_drive_delay_c {soft pre_drive_delay <=5; }
        constraint post_drive_delay_c {soft post_drive_delay <= 5; }
        constraint data_default_c {soft data.size() == 1; }
        constraint data_hard_c {soft data.size() > 0; }
        constraint offset_default_c {soft offset == 0; }
