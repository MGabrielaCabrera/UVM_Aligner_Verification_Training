`ifndef CFS_MD_DRIVER_SLAVE_SV
    ...
    class cfs_md_driver_slave#(int unsigned DATA_WIDTH = 32) extends cfs_md_driver#(.DATA_WIDTH(DATA_WIDTH), .ITEM_DRV(cfs_md_item_drv_slave)) implements cfs_md_reset_handler;
